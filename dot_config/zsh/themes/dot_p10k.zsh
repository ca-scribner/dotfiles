# Generated by Powerlevel10k configuration wizard on 2026-01-20 at 15:42 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # stuff that shows in the active prompt
    # os_icon               # os identifier
    dir                     # current directory
    vcs                     # git status
    # =========================[ Line #2 ]=========================
    newline                 # \n
    # parts that I only show in history (they're shown/hidden later below)
  ...
  # This is called the "frame", and can be enabled/disabled through `p10k display` using "left_frame" or "right_frame"
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%244F↑ took '
  ...
  # I've created my own custom version of this below, so turned the default off
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=off

  # Customize transient prompt
  # Hide 'time' segment in the current prompt so it shows only in past prompts
  # p10k-on-post-prompt controls what is seen in the active prompt (the one at the bottom)
  function p10k-on-pre-prompt() {
    p10k display '1'=show '2'=hide '3'=show
  }
  # p10k-on-post-prompt controls what is seen in the historical prompts (the past ones, 
  # which are truncated)
  function p10k-on-post-prompt() {
    emulate -L zsh -o extended_glob
    if (( P9K_COMMAND_DURATION_SECONDS >= _POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD )); then
      p10k display '1'=hide '2'=show '3'=show
    else
      p10k display '1'=hide '2'=hide '3'=show
    fi
  }
